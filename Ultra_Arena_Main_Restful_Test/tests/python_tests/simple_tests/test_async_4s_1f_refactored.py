...
from test_async_utils import get_test_config_4s_1f, run_async_test
import sys
...
def main():
    ...
    # Get the configuration for 4 strategies with 1 file
    config = get_test_config_4s_1f("combo_potential_top_4_strategies")
