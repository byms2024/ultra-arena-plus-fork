...
from test_async_utils import get_test_config_1s_4f, run_async_test
import sys
...
def main():
    ...
    # Get the configuration for 1 strategy with 4 files
    config = get_test_config_1s_4f("single_strategy_direct_file_google")
