...
def get_test_config_1s_4f(combo_name: str = "single_strategy_direct_file_google") -> TestConfig:
    """Get configuration for 1 strategy with 4 files."""
    return TestConfig(
...
def get_test_config_1s_10f(combo_name: str = "test_textF_openai_only") -> TestConfig:
    """Get configuration for 1 strategy with 10 files."""
    return TestConfig(
        combo_name=combo_name,
        file_name="10_files",
        max_wait_time=300,
...
def get_test_config_1s_252f(combo_name: str = "test_textF_openai_only") -> TestConfig:
    """Get configuration for 1 strategy with 252 files (using 200_files directory)."""
    return TestConfig(
        combo_name=combo_name,
        file_name="200_files",
...
def get_test_config_2s_1f(combo_name: str = "combo_2_text_first_strategies") -> TestConfig:
    """Get configuration for 2 strategies with 1 file."""
    return TestConfig(
        combo_name=combo_name,
        file_name="1_file",
        max_wait_time=300,
...
def get_test_config_2s_2f(combo_name: str = "test_both_strategies_openai") -> TestConfig:
    """Get configuration for 2 strategies with 2 files."""
    return TestConfig(
        combo_name=combo_name,
        file_name="2_files",
        max_wait_time=300,
...
def get_test_config_4s_1f(combo_name: str = "combo_potential_top_4_strategies") -> TestConfig:
    """Get configuration for 4 strategies with 1 file."""
    return TestConfig(
        combo_name=combo_name,
        file_name="1_file",
        max_wait_time=300,
...
def get_test_config_4s_4f(combo_name: str = "combo_potential_top_4_strategies") -> TestConfig:
    """Get configuration for 4 strategies with 4 files."""
    return TestConfig(
        combo_name=combo_name,
        file_name="4_files",
        max_wait_time=300,
...
def get_test_config_5s_1f(combo_name: str = "combo_test_5_sub_strategies") -> TestConfig:
    """Get configuration for 5 strategies with 1 file."""
    return TestConfig(
        combo_name=combo_name,
        file_name="1_file",
        max_wait_time=300,
...
def get_test_config_10s_1f(combo_name: str = "combo_test_10_strategies") -> TestConfig:
    """Get configuration for 10 strategies with 1 file."""
    return TestConfig(
        combo_name=combo_name,
        file_name="1_file",
...
def get_test_config_10s_4f(combo_name: str = "combo_test_10_strategies") -> TestConfig:
    """Get configuration for 10 strategies with 4 files."""
    return TestConfig(
        combo_name=combo_name,
        file_name="4_files",
        max_wait_time=600,  # 10 minutes
...
def get_test_config_10s_10f(combo_name: str = "combo_test_10_strategies") -> TestConfig:
    """Get configuration for 10 strategies with 10 files."""
    return TestConfig(
        combo_name=combo_name,
        file_name="10_files",
        max_wait_time=300,
...
def get_test_config_10s_252f(combo_name: str = "combo_test_10_strategies") -> TestConfig:
    """Get configuration for 10 strategies with 252 files (using 200_files directory)."""
    return TestConfig(
        combo_name=combo_name,
        file_name="200_files",
        max_wait_time=1800,  # 30 minutes for large test
...
def get_test_config_top_4s_252f(combo_name: str = "combo_test_top_4_strategies_2") -> TestConfig:
    """Get configuration for top 4 strategies with 252 files (using 200_files directory)."""
    return TestConfig(
        combo_name=combo_name,
        file_name="200_files",
        max_wait_time=1800,  # 30 minutes for large test
